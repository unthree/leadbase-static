...
export const DEFAULTS = {
  tasks: {
    lanes: [
      ...
      { id: "leadbasepro", name: "Leadbase Pro", color: "#a855f7", status: "Preparing for the beta test", shortGoal: "Finish the action generation system and launch the beta", longGoal: "" },
    ...
    tasks: [
      { id: "t1", title: "Finish the action generation system", lane: "leadbasepro", done: false, due: null },
      { id: "t2", title: "finish the landing page editor", lane: "leadbasepro", done: false, due: null }
    ]
  },
